    ...
    plugins: [
        ...
        new FileManagerPlugin({
            events: {
                onStart: {
                    delete: [
                        "./gutenverse-themes-builder/assets/js/dashboard.js*",
                        "./gutenverse-themes-builder/lib/dependencies/dashboard.asset.php"
                    ]
                },
                onEnd: {
                    copy: [
                        ...
                        },
                        {
                            ...
                            destination: "./gutenverse-themes-builder/lib/dependencies/",
                        },
                    ],
                },
            },
