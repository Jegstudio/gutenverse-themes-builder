	...
	public static function create_init_php( $system, $data, $theme_id, $include_global_import ) {
		...
		if ( ! empty( $other['dashboard'] ) && isset( $other['dashboard']['mode'] ) && 'themeforest' === $other['dashboard']['mode']['value'] ) {
			...
			if ( isset( $other['dashboard']['themeforest_mode'] ) && $other['dashboard']['themeforest_mode'] ) {
				...
				$additional_filter[] = "add_filter( 'gutenverse_companion_essential_assets_directory', function () { return $dir_string . 'assets'; });";
				$additional_filter[] = "add_filter( 'gutenverse_companion_essential_assets_url', function () { return $url_string . 'assets'; } );";
				$additional_filter[] = "add_filter( 'gutenverse_companion_essential_mode_on', '__return_true' );";
