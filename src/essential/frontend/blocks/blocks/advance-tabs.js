...
class GutenverseAdvanceTabs extends Default {
    /* public */
    init() {
    ...
    _tabItems(element) {
        ...
        const items = {
            headingItems: blockElement.find('.advance-tab-heading-item'),
            bodyItems: blockElement.find('.advance-tab-body-item'),
            mobileTabs: blockElement.find('.advance-tab-heading-mobile'),
            mobileLabel: blockElement.find('.advance-tab-dinamic-title'),
            mobileItems: blockElement.find('.advance-tab-option-item'),
        };
    ...
    _activateMobile(tabId, items) {
        items.mobileItems.map(item => {
            ...
            if (mobileItem.data('id') === tabId) {
                ...
                items.mobileLabel.html(mobileItem.html());
            }
        });
    }
...
export default GutenverseAdvanceTabs;
