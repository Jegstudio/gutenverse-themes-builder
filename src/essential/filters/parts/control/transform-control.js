...
import { TransformOriginControl } from '../../../../../gutenverse-extend/src/pro/controls/controls/transform-origin/transform-origin-control';
...
const TransformControl = (props) => {
    ...
    return transformOption(parameter);
};
