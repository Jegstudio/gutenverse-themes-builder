...
export const stickyFormBuilder = (results, props) => {
    const {
        elementId,
        sticky,
        stickyPosition,
    ...
    return [
        ...
        {
            id: 'sticky',
            label: __('Enable Sticky Form Builder', 'gutenverse-pro'),
            ...
            style: [
                {
                    selector: `.guten-form-builder.${elementId}`,
        ...
        },
        {
            ...
            style: [
                {
                    selector: `.guten-form-builder.${elementId}.pinned`,
