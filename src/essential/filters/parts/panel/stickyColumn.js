...
import { getDeviceType, isCanStickyColumn } from 'gutenverse-core/editor-helper';
...
export const stickyColumn = (result, props) => {
    if (isCanStickyColumn(props)) {
        const {
            elementId,
            sticky,
            stickyPosition,
        ...
        const _sticky = deviceStyleValue(device, sticky) && isAlignStickyColumn(sectionVerticalAlign);

        const setPositioning = (enable, position, top, bottom, zIndex) => {
            let style;
        ...
        return [
            ...
            {
                id: 'sticky',
                label: __('Enable Sticky Column', 'gutenverse-pro'),
            ...
            },
            {
                ...
                style: [
                    {
                        selector: `.guten-column.${elementId}.pinned`,
            ...
            {
                id: 'stickyShowOn',
                label: __('Sticky Show On', 'gutenverse-pro'),
                show: _sticky,
                component: SelectControl,
                options: [
                    {
            ...
            {
                id: 'topSticky',
                show: _sticky && 'top' === stickyPosition,
            ...
            {
                id: 'bottomSticky',
                show: _sticky && 'bottom' === stickyPosition,
    ...
    return [
        {
            ...
            component: AlertControl,
            children: <>
                <span>{__('Sticky column can only be used if Section\'s vertical align is set to TOP, MIDDLE, OR BOTTOM. And the section must have height for sticky column to run properly.')}</span>
            </>
        },
    ];
}