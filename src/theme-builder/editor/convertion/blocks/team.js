...
const pairs = {
    ...
    st_name_normal_color_responsive: 'nameColor',
    st_description_normal_color_responsive: 'descColor',
    st_position_normal_color_responsive: 'jobColor',
    st_description_typography_content_typography_typography: "nameTypography",
    st_name_typography_content_typography_typography: "descTypography",
    st_position_typography_content_typography_typography: "jobTypography",
};
